<?php
/**
 * Simulasi Logic Inspeksi - PHP
 */
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Logic simpan data di sini
    // Untuk simulasi, kita tetap di halaman yang sama agar modal JS bisa muncul
    // atau arahkan kembali dengan parameter sukses
}
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Inspeksi Kendaraan - Middle Mile</title>
...
<body class="bg-gray-200 flex justify-center">
    ...
    <script>
        function handleKirim() {
            ...
            // 2. Simulasi delay pengiriman data (misal 1.5 detik)
            setTimeout(() => {
                // 3. Ubah tombol menjadi sukses sejenak
