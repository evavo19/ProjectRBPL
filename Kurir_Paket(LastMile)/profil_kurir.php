...
<body>
    ...
    <div class="app-container">
        ...
        <div class="sticky-header-content pt-0 px-0">
            ...
            <div class="flex-1 overflow-y-auto no-scrollbar relative z-10 px-6 mt-6 animate-fadeIn pb-28">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="text-orange-50 text-xs font-medium opacity-90 tracking-widest uppercase">ID: Kurir-202419</p>
                </div>
        ...
        <div class="absolute bottom-0 left-0 right-0 bg-white h-20 flex justify-around items-center px-2 rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.08)] border-t border-gray-100 z-50">

            <!-- Beranda -->
            <a href="pelacakan_pengiriman.php" class="nav-item group flex flex-col items-center justify-center w-16">
                <svg class="w-6 h-6 text-gray-400 group-hover:text-brand transition-all duration-300"
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                </svg>
                <span class="text-[10px] font-bold font-montserrat text-gray-400 mt-1 group-hover:text-brand transition-colors">
                    Beranda
                </span>
            </a>
            ...
            <a href="cari.php" class="nav-item group flex flex-col items-center justify-center w-16">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="w-6 h-6 text-gray-400 group-hover:text-brand transition-all duration-300"
            ...
            <a href="tambah.php" class="nav-item group flex flex-col items-center justify-center w-16">
                <div class="w-10 h-10 bg-gray-50 rounded-full flex items-center justify-center text-gray-400 transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="w-6 h-6 text-gray-400 group-hover:text-brand transition-all duration-300"
                        fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <a href="profil_kurir.php" class="nav-item group flex flex-col items-center justify-center w-16">
                ...
                <span class="text-[10px] font-bold font-montserrat text-brand mt-1">
                    Profil
                </span>
            </a>
        </div>
