...
<head>
    ...
    <title>Detail Riwayat Sortir - Operator Sortation Center</title>
    ...
    <div class="w-full max-w-[384px] h-screen bg-white shadow-2xl relative flex flex-col md:rounded-[25px] overflow-hidden">
        ...
        <div class="flex-1 px-6 py-6 space-y-4 overflow-y-auto hide-scrollbar bg-white">
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                ...
                <a href="konfirmasi_paket_sortir.php" class="block w-full py-2 bg-orange-50 text-orange-600 border border-orange-200 rounded-lg text-center text-xs font-bold hover:bg-orange-600 hover:text-white transition-all">
        ...
        <div class="flex-none bg-white border-t border-gray-100 px-6 py-5 z-40">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-lg font-bold text-slate-800">2 Paket</p>
                </div>
                <a href="konfirmasi_paket_sortir.php" class="bg-orange-600 text-white px-5 py-2.5 rounded-xl text-sm font-semibold shadow-md active:scale-95 transition-transform">
                    Laporkan
                </a>
            </div>
        </div>
