        ...
        <div id="modalOverlay" class="fixed inset-0 bg-black/40 z-[100] flex items-center justify-center hidden">
            <div class="bg-white w-[280px] rounded-[24px] p-8 flex flex-col items-center modal-scale relative">
                <div class="w-24 h-24 bg-[#F54D2D] rounded-[20px] flex items-center justify-center mb-6">
                    <svg viewBox="0 0 24 24" fill="none" class="w-14 h-14 text-white" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round">
                        <polyline points="20 6 9 17 4 12"></polyline>
                    </svg>
                </div>

                <h3 class="text-[#F54D2D] font-bold text-center text-lg leading-tight">
                    Pesanan berhasil<br>dibuat
                </h3>

                <button onclick="closeModal()" class="mt-8 text-gray-400 text-sm font-medium hover:text-gray-600">Tutup</button>
            </div>
        </div>
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <div class="w-12 h-12 bg-white rounded-xl border border-gray-100 flex items-center justify-center shadow-sm">
                            <?php if ($cat['name'] == 'ShopeeFood'): ?>
                                <i data-lucide="utensils-crosses" class="w-7 h-7 text-orange-500"></i>
                            <?php else: ?>
