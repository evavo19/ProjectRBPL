    ...
    <div class="app-container">
        ...
        <div class="px-8 space-y-6">
            ...
            <div class="flex justify-between px-1">
                <a href="daftar_akun.php" class="text-slate-500 text-[10px] font-bold font-montserrat">Daftar</a>
                <a href="daftar_akun.php" class="text-slate-500 text-[10px] font-bold font-montserrat">Daftar dengan No. handphone</a>
            </div>
        </div>
